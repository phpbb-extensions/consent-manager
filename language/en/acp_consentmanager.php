...
$lang = array_merge($lang, [
	...
	'ACP_CONSENTMANAGER_EXPORT_USERNAME_EXPLAIN'	=> 'Enter a registered username to restrict the export (or delete) to that user’s consent records. Leave blank to include all users.',
